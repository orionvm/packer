...
type config struct {
	...
	XenBinary       string     `mapstructure:"qemu_binary"`
...
func (b *Builder) Prepare(raws ...interface{}) ([]string, error) {
	...
	if b.config.XenBinary == "" {
		b.config.XenBinary = "xm"
	}
...
func (b *Builder) Run(ui packer.Ui, hook packer.Hook, cache packer.Cache) (packer.Artifact, error) {
	...
	driver, err := b.newDriver(b.config.XenBinary)
	if err != nil {
